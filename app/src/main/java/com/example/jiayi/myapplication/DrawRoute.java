...
public class DrawRoute {
    ...
    public void setUpMapAndRequestRouter(LatLng src,LatLng dest){
        ...
        map.addMarker(options_destination);
    ...
    private String getDirectionsUrl(LatLng origin,LatLng dest){
        ...
        //String parameters="origin=Carnegie Mellon University&destination=melwood avenue&"+mode;
